...
//creamos un procedimiento para buscarlo
function Buscar(codigo){
    var db=database.ref().child("registro");
    db.once("value", function(snapshot){
        snapshot.forEach(function (data){
            //declaramos una variable para obtener el ID de la tabla
            var key=data.key;
            //verificar si el codigo es igual al ID de tabla
            if(key==codigo){
...
//creamos un procedimineto para mostrar los datos de la tabla
function Mostrar(){
